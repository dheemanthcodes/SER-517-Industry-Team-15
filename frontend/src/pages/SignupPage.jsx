...
function SignupPage({ onGoToLogin }) {
  ...
  return (
    <div className="auth-container auth-split auth-split--signup">
          ...
          <Card className="auth-card auth-card--split">
            <div className="login-header">
              <div style={{ textAlign: 'center', marginBottom: '12px' }}>
                <img src="/logo.png" alt="Logo" style={{ width: '64px', height: 'auto' }} />
              </div>
              <Typography.Title level={3}>Create Account</Typography.Title>
              <Typography.Text type="secondary">Sign up to get started</Typography.Text>
            </div>
            ...
            <div className="auth-social-buttons">
              ...
              >
                <svg className="auth-microsoft-icon" viewBox="0 0 24 24" aria-hidden="true">
                  <path fill="#f25022" d="M2 2h9.5v9.5H2z" />
                  <path fill="#7fba00" d="M12.5 2H22v9.5h-9.5z" />
                  <path fill="#00a4ef" d="M2 12.5h9.5V22H2z" />
                  <path fill="#ffb900" d="M12.5 12.5H22V22h-9.5z" />
                </svg>
                <span className="auth-microsoft-text">
